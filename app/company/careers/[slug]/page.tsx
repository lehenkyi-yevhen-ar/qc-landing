                ...
                <div className="qc-job-hero-meta">
                  <div className="qc-job-hero-meta-group">
                    ...
                    <span className="qc-job-hero-meta-value qc-job-hero-meta-location">
                      <img src="/icons/location-icon.png" alt="Location icon" style={{width: 22, height: 28}}/>
                      {job.location}
                    </span>
                  </div>
                  <div className="qc-job-hero-meta-group">
            ...
            <div className="qc-job-hero-right">
              <div className="qc-job-apply-card">
                ...
                <div className="qc-job-apply-card-avatars">
                  <Image src="/team-avatars.png" alt="Team" width={230} height={86} style={{ objectFit: 'contain' }} />
                </div>
              ...
              <ul className="qc-job-list">
                {job.responsibilities.map((item, i) => (
                  <li key={i} className="qc-job-list-item">
                    <img src="/icons/chekmark-main.png" alt="Checkmark violet" style={{width: 28, height: 28}}/>
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
              ...
              <div className="qc-job-block">
                ...
                <ul className="qc-job-list">
                  {job.requirements.map((item, i) => (
                    <li key={i} className="qc-job-list-item">
                    <img src="/icons/star-violet.png" alt="Star violet" style={{width: 28, height: 28}}/>
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
            ...
            <div className="qc-job-block">
              ...
              <ul className="qc-job-list">
                {job.benefits.map((item, i) => (
                  <li key={i} className="qc-job-list-item">
                    <img src="/icons/heart-square-violet.png" alt="Heart square violet" style={{width: 28, height: 28}}/>
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
              ...
              <div className="qc-careers-form-col">
                ...
                <form onSubmit={handleSubmit} className="qc-journey-form">
                  <div className="qc-journey-fields">
                    <div className="qc-journey-field">
                      <div className="qc-input-wrap qc-journey-input-wrap">
                        ...
                        />
                        <button type="button" className="qc-input-icon qc-journey-input-icon qc-journey-input-icon-clear" onClick={() => setForm(c => ({ ...c, firstName: '' }))} aria-label="Clear first name">
                    ...
                    <div className="qc-journey-field">
                      <div className="qc-input-wrap qc-journey-input-wrap">
                        ...
                        <input
                          ...
                          className="qc-input qc-journey-input"
                        />
                        <button type="button" className="qc-input-icon qc-journey-input-icon qc-journey-input-icon-clear" onClick={() => setForm(c => ({ ...c, lastName: '' }))} aria-label="Clear last name">
                          <Image src="/icons/inactive-cross.png" alt="" width={25} height={25} className="qc-clear-icon qc-clear-icon-inactive" />
                          <Image src="/icons/active-cross.png" alt="" width={25} height={25} className="qc-clear-icon qc-clear-icon-active" />
                        </button>
                      </div>
                    ...
                    <div className="qc-journey-field">
                      <div className="qc-input-wrap qc-journey-input-wrap">
                        ...
                        <input
                          ...
                          className="qc-input qc-journey-input"
                        />
                        <button type="button" className="qc-input-icon qc-journey-input-icon qc-journey-input-icon-clear" onClick={() => setForm(c => ({ ...c, linkedin: '' }))} aria-label="Clear LinkedIn">
                          <Image src="/icons/inactive-cross.png" alt="" width={25} height={25} className="qc-clear-icon qc-clear-icon-inactive" />
                          <Image src="/icons/active-cross.png" alt="" width={25} height={25} className="qc-clear-icon qc-clear-icon-active" />
                        </button>
                      </div>
                  ...
                  <div className="qc-journey-upload-wrap">
                    <input ref={fileInputRef} type="file" accept=".pdf,.docx" style={{ display: 'none' }} onChange={e => setForm(c => ({ ...c, cvFile: e.target.files?.[0] ?? null }))} aria-label="Upload CV" />
                    <button type="button" className="qc-journey-upload-btn" onClick={() => fileInputRef.current?.click()}>
                  ...
                  <div className="qc-journey-cta-wrap">
                    <button type="submit" className="qc-journey-cta qc-conversation-cta qc-careers-apply-cta" disabled={isSubmitting}>
